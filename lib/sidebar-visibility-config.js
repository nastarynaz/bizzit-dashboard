 ...
 * Contr  // 💬 Chatbot page
  ...
  // 🔧 API Debug page (Development tool)
  apiDebug: {
    name: "API Debug",
    visible: true,  // ✅ VISIBLE - Set to false to hide (recommended for production)
    description: "Debug and test external API connectivity"
